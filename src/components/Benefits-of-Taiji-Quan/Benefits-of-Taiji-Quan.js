    ...
    return (
        <div className="homeContent">
            <Jumbotron className="jumbotron-content">
                ...
                <h2 className="header2 TaijiQuan toLowerCase">
                    <span className="HomeTitle">Reduction of Stress :</span>
                    <div className="homeHorizontalLine"></div>
                </h2>
                ...
                <h2 className="header2 TaijiQuan toLowerCase">
                    <span className="HomeTitle">Nervous System :</span>
                    <div className="homeHorizontalLine"></div>
                </h2>

                <p className="homeText">Regular practice of Taichi strengthens the nervous system. Hence it is beneficial to those who are working under constant pressure and suffering from sleeplessness.</p>

                <h2 className="header2 TaijiQuan toLowerCase">
                    <span className="HomeTitle">Respiratory System :</span>
                    <div className="homeHorizontalLine"></div>
                </h2>

                <p className="homeText">By practising Taichi one begins to breathe deeply which helps the Chi to sink into the Dan Tien – two inches below the naval, also called the waist. This process improves the oxygenation of the blood and the elasticity of the living tissues and rejynevation of the entire system of human body.</p>

                <h2 className="header2 TaijiQuan toLowerCase">
                    <span className="HomeTitle">Cardio Vascular System :</span>
                    <div className="homeHorizontalLine"></div>
                </h2>

                <p className="homeText">The movements of Taichi are light, agile and soft. This improves the functioning of the lymphatic system and circulation of blood. A more efficient circulatory system reduces the work load of the heart. So the doctors recommend their patients suffering from heart diseases and blood pressure problems to have regular Taichi practice. </p>

                <h2 className="header2 TaijiQuan toLowerCase">
                    <span className="HomeTitle">Muscles, joints and Tendons :</span>
                    <div className="homeHorizontalLine"></div>
                </h2>
                <p className="homeText">Taichi practice trains your body movements to be in a circular and parabolic motion. During practice all the muscles and joints of the body are involved in performing the movements. So muscles, joints and Tendons do not become stiff. They are flexible and stronger.</p>

                <h2 className="header2 TaijiQuan toLowerCase">
                    <span className="HomeTitle">Circulation of Chi :</span>
                    <div className="homeHorizontalLine"></div>
                </h2>
                <p className="homeText">Sickness is caused by the blocking of “ Chi” along the meridians. But Taichi is one of the tools like Acupuncture, works to stimulate the body to facilitate the free flow of “ Chi” along the meridians </p>

                <h2 className="header2 TaijiQuan toLowerCase">
                    <span className="HomeTitle">Relaxation :</span>
                    <div className="homeHorizontalLine"></div>
                </h2>
                <p className="homeText">Regular practice of Taichi helps one to have mental and physical relaxation. Mental and physical relaxation helps the practitioner of Taichi to reduce the stress. Also Taichi has the ability to strengthen the body and mind as it is a integrated exercise that combines external and internal coordination. It is suitable for all ages for the youth and the senior citizens as well as those who are weak physically. </p>
            </Jumbotron>
        </div>
    );
};
